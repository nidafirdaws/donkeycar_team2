...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if camera_type == "stereo":
        ...
        if cfg.CAMERA_TYPE == "WEBCAM":
            ...
            from donkeycar.parts.cv import OAKD

            camA = OAKD(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, iCam = 0)
            camB = OAKD(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, iCam = 1)
        ...
        if cfg.DONKEY_GYM:
            ...
            cam = OAKD(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, camera_index=cfg.CAMERA_INDEX)
        elif cfg.CAMERA_TYPE == "CVCAM":
            from donkeycar.parts.cv import CvCam
...
#This web controller will create a web server that is capable
    ...
    if cfg.CAMERA_TYPE == "OAKD":
        inputs = ['cam/image_array', 'user/angle', 'user/throttle', 'user/mode']
        types = ['image_array', 'float', 'float', 'str']

#        if cfg.OAKD_DEPTH:
 #           inputs.append('cam/depth_array')
  #          types.append('gray16_array')  # Format for depth images
