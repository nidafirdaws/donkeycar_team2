...
DEPTH_ENABLED = True  # Add a flag to enable depth capture - NEW AS OF THURSDAY 1.29.25 - NIDA
OAKD_DEPTH = True # Add OAKD Depth 2/3/2025
IMAGE_W = 1280
IMAGE_H = 720
...
# LOGGING_LEVEL = 'WARNING'          # (Python logging level) 'NOTSET' / 'DEBUG' / 'INFO' / 'WARNING' / 'ERROR' / 'FATAL' / 'CRITICAL'
